...
local plugins = {
  ...
  {[1] = "machakann/vim-sandwich", config = function() end}
}
function M.init_plugins()
  ...
  for I = 1, #lsp_plugins do plugins[#plugins + 1] = lsp_plugins[I] end

  local window_plugins = require("plugins.window")
  for I = 1, #window_plugins do plugins[#plugins + 1] = window_plugins[I] end
